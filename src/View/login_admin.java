...
Controller C = new Controller();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/admin-settings-male.png"))); // NOI18N
...
//        if(username.equalsIgnoreCase("Thomas")&& password.equalsIgnoreCase("1234"))
//       {
...
//       }
if(C.Loginadmin(txt_username.getText(), txt_password.getText())==true)
       {
        this.dispose();     //Menghilangkan JFrame agar tidak dobel
        String admin = txt_username.getText();
        String idNumber= txt_password.getText();
        Admin Shp= new Admin();
        String nama=C.Dataad(idNumber).getNama();String tanggalmasuk=C.DataSh(idNumber).getTanggalmasuk();
        Shp= new Admin(admin, nama, idNumber,tanggalmasuk);
        new menu_admin().setVisible(true);
        Shp.getNama();
       }
       else
