 ...
 * @author TS <TS.com>
 */
public class riwayat_transaksi1 extends javax.swing.JFrame {
...
//            table.removeRow(0);
//        }
//int juml= C.cekjumlahtransaksi();
//        System.out.println(juml);
//int i=0;
////for(i=0;i<juml;i++){
//        
//             do{
////             System.out.println(i+"INIIIII");
////     while (C.showallPembelian().ne()){
//
//System.out.println(i);
//
//         String kode = String.valueOf(C.showallPembelian().getPembelian()[i].getKode_barang());
//                    String nama = C.showallPembelian().getPembelian()[i].getNama_barang();
//                    String harga = String.valueOf(C.showallPembelian().getPembelian()[i].getHarga());
//                     String jumlah = String.valueOf(C.showallPembelian().getPembelian()[i].getJumlah());
//                    String total = String.valueOf(C.showallPembelian().getPembelian()[i].getTotalharga());
...
//        }  
//    
        String query = "SELECT * FROM Woman FULL JOIN table Kid ";
        ...
        try{
            ...
            while (rslt.next()){
                ...
                String[] data = {id,koleksi,kode,nama,jumlah,harga,total,tanggal};
                //menambahakan baris sesuai dengan data yang tersimpan diarray
                table.addRow(data);
            }
                //mengeset nilai yang ditampung agar muncul di table
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(riwayat_transaksi1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new riwayat_transaksi1().setVisible(true);
            }
        });
    }
